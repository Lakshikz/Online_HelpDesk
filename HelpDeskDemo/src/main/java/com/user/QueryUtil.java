...
/**
 * This load Sql queries available in the web.xml
 * @see #CommonUtil
 */
public class QueryUtil extends CommanUtil {
	 ...
	 * 
	 * @see UserServicel#addUser()
	 * @see UserService#createUser()
	 * @see UserService#displayAllUsers()
	 * @see UserService#removeUser(String)
	 * 
	 */
	public static String queryByID(String id) throws SAXException, IOException, ParserConfigurationException {
		...
		/*
		 * Read the web.xml file and read each query node into node
